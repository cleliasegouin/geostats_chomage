...
other_variables = cbind(indicateurs_par_com$taux_CHOM1564_POP1564,indicateurs_par_com$freq_par_hab,indicateurs_par_com$stop_id,indicateurs_par_com$MED20,indicateurs_par_com$temps_moyen_TC_comm,indicateurs_par_com$temps_moyen_VP_comm,indicateurs_par_com$euclidean_distance_centroid)
