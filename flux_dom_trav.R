...
df_pop_chom = select(df_pop_active, CODGEO, P20_CHOM1564, taux_CHOM1564_POP1564,POPULATION)
...
data_revenus = select(data_revenus, CODGEO, MED20,NBPERSMENFISC20,NBMENFISC20)
...
VP_flux_duration_idf_chom_revenu$NBPERSMENFISC20 = as.numeric(VP_flux_duration_idf_chom_revenu$NBPERSMENFISC20,rm.na=T)
...
rm(VP_flux_duration_idf_chom_revenu$MED20,VP_flux_duration_idf_chom_revenu$P20_CHOM1564)
